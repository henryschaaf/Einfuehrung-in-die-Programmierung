...
void do_test_1(Tester *tester, TestCase1 test) {
    ...
    HeightTreeNode *got_root = rotate_right(test.before_rotation);
...
HeightTreeNode *htn_tlll() {
    HeightTreeNode *t = htn_tll();
    HeightTreeNode *lll = height_tree_new_asdf(3, t->left->left);
    t->left->left->left = lll;
...
HeightTreeNode *htn_tll_r() {
    HeightTreeNode *t = htn_ltr();
    HeightTreeNode *ll = height_tree_new_asdf(3, t->left);
    t->left->left = ll;
    t->left->height = 2;
    t->height = 3;
    return t;
...
HeightTreeNode *htn_tllr() {
    HeightTreeNode *t = htn_tll();
    HeightTreeNode *llr = height_tree_new_asdf(6, t->left->left);
    t->left->left->right = llr;
    t->left->left->height = 2;
    t->left->height = 3;
    t->height = 4;
    return t;
...
HeightTreeNode *htn_tlr_r() {
    HeightTreeNode *t = htn_ltr();
    HeightTreeNode *lr = height_tree_new_asdf(6, t->left);
    t->left->right = lr;
    t->left->height = 2;
    t->height = 3;
    return t;
...
HeightTreeNode *htn_tlrl() {
    HeightTreeNode *t = htn_tll();
    HeightTreeNode *lrl = height_tree_new_asdf(8, t->left);
    t->left->right = lrl;
    return t;
}

HeightTreeNode *htn_tlrl_r() {
    HeightTreeNode *t = htn_ltr();
    HeightTreeNode *lrl = height_tree_new_asdf(8, t->right);
    t->right->left = lrl;
    t->height++;
    t->right->height++;
    return t;
...
int main(int argc, char const *argv[]) {
    ...
    /* Aufgabe 1 */
    if (begin_exercise(&tester, "rotate_right", "Aufgabe 1: Rechtsrotation."))
    {
        if (begin_testcase(&tester)) {
            TestCase1 test;
            test.before_rotation = htn_9_7();
            test.after_rotation = htn_7_9();
        ...
        if (begin_testcase(&tester)) {
            TestCase1 test;
            test.before_rotation = htn_tlll();
            test.after_rotation = htn_tll_r();
        ...
        if (begin_testcase(&tester)) {
            ...
            test.after_rotation = htn_trr();

            do_test_1(&tester, test);
        }
        if (begin_testcase(&tester)) {
            TestCase1 test;
            test.before_rotation = htn_tlrl();
            test.after_rotation = htn_tlrl_r();
