...
static TestCase test_cases1[TEST_CASES_1] = {
    {.len = 5, .arr = (uint8_t[5]){128, 196, 0, 255, 64}, .count = 4, .name = "partition1", .file_in = "partition1.png"},
    {.len = 5, .arr = (uint8_t[5]){128, 64, 0, 255, 196}, .count = 2, .name = "partition2", .file_in = "partition2.png"},
    {.len = 9, .arr = (uint8_t[9]){64, 192, 224, 128, 32, 0, 255, 128, 96}, .count = 6, .name = "partition3", .file_in = "partition3.png"},
    ...
    {.len = 5, .arr = (uint8_t[5]){128, 128, 128, 128, 128}, .count = 5, .name = "partition6", .file_in = "partition6.png"},
};
